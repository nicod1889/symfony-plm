...
class ProductoController extends AbstractController {
    ...
    #[Route('/', name: 'app_producto_index', defaults: ['page' => '1'], methods: ['GET'])]
    #[Route('/page/{page<[0-9]\d*>}', name: 'producto_index_paginated', methods: ['GET'])]
    public function index(ProductoRepository $productoRepository, int $page): Response {
        $latestProducts = $productoRepository->findLatest($page);
